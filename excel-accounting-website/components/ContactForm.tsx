...
export default function ContactForm(): React.ReactElement {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="contact-phone" className="text-sm font-medium text-navy">Cell Phone</label>
        <input
          id="contact-phone"
          type="tel"
          autoComplete="tel"
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="contact-company" className="text-sm font-medium text-navy">Company</label>
        <input
          id="contact-company"
          type="text"
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="contact-message" className="text-sm font-medium text-navy">Message</label>
        <textarea
          id="contact-message"
          rows={4}
          {...register('message')}
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full bg-teal hover:bg-teal-dark text-white font-semibold rounded px-6 transition-colors duration-200 min-h-[44px] disabled:opacity-60 disabled:cursor-not-allowed"
      >
