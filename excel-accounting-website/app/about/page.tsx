      ...
      <section className="py-20 px-6 bg-white">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-5 text-gray-500 leading-relaxed">
            <p>
              By combining all 3 of these pillars, we create a competitive advantage in building
              long-term relationships and ensure success for both our clients and our company.
            </p>
            <p>
              In today&apos;s fast-paced business environment you need the right value propositions
              to make a business succeed and we can offer these solutions.
            </p>
            <p>
              Being a small firm we are passionate about personal service and see our client&apos;s
              success as an extension of our own success. With complex regulation being passed down
              by the regulators, you need a partner that understands your business.
            </p>
            <p>
              In the ever changing dynamic world, we ensure that we keep up to date with all the
              current developments by sending our staff on year-round training. This ensures that
              our clients are kept abreast of the latest regulations and escape the many pitfalls so
              many companies fall into because of following outdated regulations and laws.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-gray-500 mb-8">
            For more information feel free to contact us. We&apos;d love to hear from you.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center border border-navy text-navy hover:bg-navy hover:text-white font-semibold px-8 rounded transition-colors duration-200 min-h-[44px]"
            >
              Contact Us
            </Link>
          </div>
